...
includes subjects and metadata definitions.

Glance subject services include discovering, registering, and
retrieving virtual machine subjects. Glance has a RESTful API that allows
querying of VM subject metadata as well as retrieval of the actual subject.

.. include:: deprecation-note.inc

VM subjects made available through Glance can be stored in a variety of
