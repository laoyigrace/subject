...
different types of resources (subjects, artifacts, volumes, flavors, aggregates,
...
a flavor or subject. They will see the virtual CPU topology property in the list
...
resource (Nova for flavors and in Glance for subjects).

Diagram: https://wiki.openstack.org/w/subjects/b/bb/Glance-Metadata-API.png
...
We issue a ``GET`` request to ``http://subject.openstack.example.org/v2/metadefs/namespaces``
...
We issue a ``GET`` request to ``http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}``
...
We issue a ``GET`` request to ``http://subject.openstack.example.org/v2/metadefs/resource_types``
...
We issue a ``GET`` request to ``http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}/resource_types``
...
We issue a ``POST`` request to add an namespace to Glance::
  ...
  POST http://subject.openstack.example.org/v2/metadefs/namespaces/
...
We issue a ``PUT`` request to update an namespace to Glance::
  ...
  PUT http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}
...
We issue a ``DELETE`` request to delete an namespace to Glance::
  ...
  DELETE http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}
...
We issue a ``POST`` request to associate resource type to Glance::
  ...
  POST http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}/resource_types
...
Glance::
  ...
  DELETE http://subject.openstack.example.org/v2//metadefs/namespaces/{namespace}/resource_types/{resource_type}
...
We issue a ``GET`` request to ``http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}/objects``
to retrieve objects.
...
We issue a ``POST`` request to add object to a namespace in Glance::
  ...
  POST http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}/objects
...
We issue a ``PUT`` request to update an object to Glance::
  ...
  PUT http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}/objects/{object_name}
...
We issue a ``DELETE`` request to delete object in a namespace to Glance::
  ...
  DELETE http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}/objects/{object_name}
...
Glance::
  ...
  POST http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}/properties
...
Glance::
  ...
  PUT http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}/properties/{property_name}
...
Glance::
  ...
  DELETE http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}/properties/{property_name}
...
A typical curl API request will be like below::
   ...
   http://subject.openstack.example.org/v2/metadefs/namespaces/{namespace}
