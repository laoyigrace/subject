...
__all__ = [
    'get_task',
    'unpack_task_input',
    'set_base_subject_properties',
    'validate_location_uri',
    'get_subject_data_iter',
]
...
def unpack_task_input(task):
    ...
    for key in ["import_from", "import_from_format", "subject_properties"]:
...
def set_base_subject_properties(properties=None):
    """Sets optional base properties for creating Subject.
...
def get_subject_data_iter(uri):
    ...
    if uri.startswith("file://"):
        ...
        # into memory. Some subjects may be quite heavy.
        return open(uri, "r")
