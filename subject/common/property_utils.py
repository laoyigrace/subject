...
A property protection file, when set, restricts the Glance subject
...
is not found, the subject-api service will fail to start.
More information on property protections can be found at:
http://docs.openstack.org/developer/subject/property-protections.html
...
subject properties. The two permissible values are ``roles``
...
http://docs.openstack.org/developer/subject/property-protections.html#examples
...
class PropertyRules(object):
    ...
    def __init__(self, policy_enforcer=None):
        ...
        self.policies = []
        self.policy_enforcer = policy_enforcer or subject.api.policy.Enforcer()
