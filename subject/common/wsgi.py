...
bind_opts = [
    ...
    cfg.StrOpt('bind_host',
               default='0.0.0.0',
               help=_("""
IP address to bind the subject servers to.

Provide an IP address to bind the subject server to. The default
value is ``0.0.0.0``.
...
class Server(object):
    ...
    def __init__(self, threads=1000, initialize_subject_store=False):
        ...
        try:
            ...
            # NOTE(flaper87): When running subject-control,
            # (subject's functional tests, for example)
            # setpgid fails with EPERM as subject-control
            ...
            #
            # Running subject-(api|registry) is safe and
...
class Request(webob.Request):
    ...
    def best_match_language(self):
        ...
        if not self.accept_language:
            return None
        langs = i18n.get_available_languages('subject')
