...
class StorageQuotaFull(GlanceException):
    message = _("The size of the data %(subject_size)s will exceed the limit. "
...
class UploadException(GlanceException):
    message = _('Subject upload problem: %s')
...
class InvalidSwiftStoreConfiguration(Invalid):
    message = _("Invalid configuration in subject-swift conf file.")
