...
from subject.async.flows import introspect
...
class TestImportTask(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        task_input = {
            ...
            "subject_properties": mock.sentinel.subject_properties
        }
    ...
    def test_introspect_success(self):
        subject_create = introspect._Introspect(self.task.task_id,
                                              self.task_type,
                                              self.img_repo)
        ...
        with mock.patch.object(processutils, 'execute') as exc_mock:
            ...
            subject_create.execute(subject, '/test/path.qcow2')
    ...
    def test_introspect_no_subject(self):
        subject_create = introspect._Introspect(self.task.task_id,
                                              self.task_type,
                                              self.img_repo)
