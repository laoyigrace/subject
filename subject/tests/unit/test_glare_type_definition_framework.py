...
import subject.common.exception as exc
from subject.common.glare import declarative
import subject.common.glare.definitions as defs
...
class TestArtifactType(test_utils.BaseTestCase):
    ...
    def test_blob(self):
        class TestType(defs.ArtifactType):
            subject_file = defs.BinaryObject(max_file_size=201054,
                                           min_locations=1,
                                           max_locations=5)
        ...
        tt.subject_file = blob

        self.assertEqual(1024, tt.subject_file.size)
        self.assertEqual(["file://some.file.path"], tt.subject_file.locations)
