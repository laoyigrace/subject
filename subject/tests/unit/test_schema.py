...
class TestBasicSchema(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.schema = subject.schema.Schema('basic', properties)
...
class TestBasicSchemaLinks(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.schema = subject.schema.Schema('basic', properties, links)
...
class TestPermissiveSchema(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.schema = subject.schema.PermissiveSchema('permissive', properties)
...
class TestCollectionSchema(test_utils.BaseTestCase):
    ...
    def test_raw_json_schema(self):
        ...
        item_schema = subject.schema.Schema('mouse', item_properties)
        collection_schema = subject.schema.CollectionSchema('mice', item_schema)
        expected = {
            'name': 'mice',
            'properties': {
                'mice': {
