...
class TestScriptsUtils(test_utils.BaseTestCase):
    ...
    def test_unpack_task_input_error(self):
        task_input1 = {"import_from_format": "bar", "subject_properties": "baz"}
        task_input2 = {"import_from": "foo", "subject_properties": "baz"}
    ...
    def test_set_base_subject_properties(self):
        properties = {}
        script_utils.set_base_subject_properties(properties)
    ...
    def test_set_base_subject_properties_none(self):
        properties = None
        script_utils.set_base_subject_properties(properties)
        self.assertIsNone(properties)

    def test_set_base_subject_properties_not_empty(self):
