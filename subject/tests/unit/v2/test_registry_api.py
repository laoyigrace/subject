...
class TestRegistryRPC(base.IsolatedUnitTest):
    ...
    def _compare_subjects_and_uuids(self, uuids, subjects):
        self.assertListEqual(uuids, [subject['id'] for subject in subjects])

    def test_show(self):
        """Tests that registry API endpoint returns the expected subject."""
        fixture = {'id': UUID2,
                   'name': 'fake subject #2',
                   'size': 19,
                   'min_ram': 256,
    ...
    def test_get_index(self):
        """Tests that the subject_get_all command returns list of subjects."""
        fixture = {'id': UUID2,
                   'name': 'fake subject #2',
                   'size': 19,
                   'checksum': None}
        ...
        subjects = jsonutils.loads(res.body)[0]
    ...
    def test_get_index_marker(self):
        ...
        self._compare_subjects_and_uuids(uuid_list, subjects)
    ...
    def test_get_index_limit(self):
        ...
        self._compare_subjects_and_uuids([UUID4], subjects)
    ...
    def test_get_index_filter_on_user_defined_properties(self):
        ...
        subjects = jsonutils.loads(res.body)[0]
        self.assertEqual(2, len(subjects))
        self.assertEqual(extra_id, subjects[0]['id'])
        self.assertEqual(UUID1, subjects[1]['id'])
    ...
    def test_get_index_sort_multiple_keys_one_sort_dir(self):
        ...
        public subjects sorted by name-size and size-name with ascending
        sort direction.
        """
        uuid4_time = timeutils.utcnow() + datetime.timedelta(seconds=10)
        uuid3_time = uuid4_time + datetime.timedelta(seconds=5)
    ...
    def test_get_index_sort_multiple_keys_multiple_sort_dirs(self):
        """
        Tests that the registry API returns list of
        public subjects sorted by name-size and size-name
    ...
    def test_create_subject(self):
        """Tests that the registry API creates the subject"""
    ...
    def test_create_subject_bad_name(self):
        fixture = {'name': u'A bad name \U0001fff2', 'status': 'queued'}
        self._expect_fail('subject_create',
                          {'values': fixture},
                          'subject.common.exception.Invalid')

    def test_create_subject_bad_location(self):
    ...
    def test_create_subject_bad_property(self):
        fixture = {'status': 'queued',
    ...
    def test_update_subject_bad_tag(self):
        self._expect_fail('subject_tag_create',
                          {'value': u'\U0001fff2', 'subject_id': UUID2},
                          'subject.common.exception.Invalid')

    def test_update_subject_bad_name(self):
        fixture = {'name': u'A bad name \U0001fff2'}
        self._expect_fail('subject_update',
                          {'values': fixture, 'subject_id': UUID1},
                          'subject.common.exception.Invalid')

    def test_update_subject_bad_location(self):
        fixture = {'locations':
                   [{'url': u'file:///tmp/subject-tests/\U0001fee2',
                     'metadata': {},
                     'status': 'active'}]}
        self._expect_fail('subject_update',
                          {'values': fixture, 'subject_id': UUID1},
    ...
    def test_update_bad_property(self):
        ...
        self._expect_fail('subject_update',
                          {'values': fixture, 'subject_id': UUID2},
                          'subject.common.exception.Invalid')
    ...
    def test_delete_subject(self):
        """Tests that the registry API deletes the subject"""
        ...
        orig_num_subjects = len(res_dict)

        # Delete subject #2
        cmd = [{
            'command': 'subject_destroy',
            'kwargs': {'subject_id': UUID2}
        }]
        req.body = jsonutils.dump_as_bytes(cmd)
    ...
    def test_delete_subject_response(self):
        ...
        self.assertEqual(200, res.status_int)
        deleted_subject = jsonutils.loads(res.body)[0]
