...
[app:registryapp]
paste.app_factory = subject.registry.api.v1:API.factory
...
class ApiTest(test_utils.BaseTestCase):
    ...
    def _setup_database(self):
        ...
        subject.db.sqlalchemy.api.clear_db_env()
    ...
    def _setup_stores(self):
        ...
        subject_dir = os.path.join(self.test_dir, "subjects")
        self.config(group='glance_store',
                    filesystem_store_datadir=subject_dir)
    ...
    def _connect_registry_client(self):
        ...
        self.stubs.Set(subject.common.client.BaseClient,
