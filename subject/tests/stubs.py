...
from subject.api.middleware import context
...
def stub_out_registry_and_store_server(stubs, base_dir, **kwargs):
    ...
    def fake_sendable(self, body):
        ...
        if force is None:
            ...
            if force:
                assert subject.common.client.SENDFILE_SUPPORTED
            return force

    stubs.Set(subject.common.client.BaseClient, 'get_connection_type',
              fake_get_connection_type)
    setattr(subject.common.client.BaseClient, '_stub_orig_sendable',
            subject.common.client.BaseClient._sendable)
    stubs.Set(subject.common.client.BaseClient, '_sendable',
              fake_sendable)
