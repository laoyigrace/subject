...
class TestNamespaces(functional.FunctionalTest):
    ...
    def test_namespace_lifecycle(self):
        ...
        path = self._url('/v1/metadefs/namespaces/MyNamespace')
        response = requests.get(path, headers=self._headers())
        self.assertEqual(404, response.status_code)

        # Create a namespace
        path = self._url('/v1/metadefs/namespaces')
        ...
        expected_namespace = {
            ...
            "protected": False,
            "owner": TENANT1,
            "self": "/v1/metadefs/namespaces/%s" % namespace_name,
            "schema": "/v1/schemas/metadefs/namespace"
        }
        ...
        path = self._url('/v1/metadefs/namespaces/%s' % namespace_name)
    ...
    def test_metadef_dont_accept_illegal_bodies(self):
        # Namespace should not exist
        path = self._url('/v1/metadefs/namespaces/bodytest')
        response = requests.get(path, headers=self._headers())
        self.assertEqual(404, response.status_code)
        ...
        data_urls = [
            '/v1/schemas/metadefs/namespace',
            '/v1/schemas/metadefs/namespaces',
            '/v1/schemas/metadefs/resource_type',
            '/v1/schemas/metadefs/resource_types',
            '/v1/schemas/metadefs/property',
            '/v1/schemas/metadefs/properties',
            '/v1/schemas/metadefs/object',
            '/v1/schemas/metadefs/objects',
            '/v1/schemas/metadefs/tag',
            '/v1/schemas/metadefs/tags',
            '/v1/metadefs/resource_types',
        ]
        ...
        test_urls = [
            ('/v1/metadefs/namespaces/%s/resource_types', 'get'),
            ('/v1/metadefs/namespaces/%s/resource_types/type', 'delete'),
            ('/v1/metadefs/namespaces/%s', 'get'),
            ('/v1/metadefs/namespaces/%s', 'delete'),
            ('/v1/metadefs/namespaces/%s/objects/name', 'get'),
            ('/v1/metadefs/namespaces/%s/objects/name', 'delete'),
            ('/v1/metadefs/namespaces/%s/properties', 'get'),
            ('/v1/metadefs/namespaces/%s/tags/test', 'get'),
            ('/v1/metadefs/namespaces/%s/tags/test', 'post'),
            ('/v1/metadefs/namespaces/%s/tags/test', 'delete'),
        ]
