...
from subject.api.v2.model.metadef_resource_type import ResourceType
from subject.api.v2.model.metadef_resource_type import ResourceTypeAssociation
from subject.api.v2.model.metadef_resource_type import ResourceTypeAssociations
from subject.api.v2.model.metadef_resource_type import ResourceTypes
...
class ResourceTypeController(object):
    def __init__(self, db_api=None, policy_enforcer=None):
        ...
        self.gateway = subject.gateway.Gateway(db_api=self.db_api,
    ...
    return {
        ...
        'properties_target': {
            ...
            'description': _('Some resource types allow more than one key / '
                             ...
                             'allows user and subject metadata on volumes. Only '
                             'the subject properties metadata is evaluated by '
...
def get_collection_schema():
    ...
    return subject.schema.CollectionSchema('resource_type_associations',
