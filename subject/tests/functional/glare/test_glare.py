...
from subject.api.glare.v0_1 import glare
from subject.api.glare.v0_1 import router
from subject.common.glare import definitions
from subject.common.glare import loader
...
def _create_resource():
    ...
    with mock.patch(mock_this) as fep:
        path = 'subject.tests.functional.glare.test_glare'
        fep.return_value = [
...
class TestArtifacts(functional.FunctionalTest):
    ...
    def setUp(self):
        ...
        self.api_server.server_module = 'subject.cmd.glare'
...
[app:apiversions]
paste.app_factory = subject.api.glare.versions:create_resource

[app:glareapi]
paste.app_factory =
   subject.tests.functional.glare.test_glare:TestRouter.factory

[filter:versionnegotiation]
paste.filter_factory =
 subject.api.middleware.version_negotiation:
