...
def from_migration_import(module_name, fromlist):
    ...
    :param module_name: name of migration module to import from
        (ex: 001_add_subjects_table)
    :param fromlist: list of items to import (ex: define_subjects_table)
    ...
    Example Usage:
        ...
        # Refer to subjects table
    """
    module_path = 'subject.db.sqlalchemy.migrate_repo.versions.%s' % module_name
