...
from subject.api.glare import versions as artifacts_versions
...
class VersionNegotiationFilter(wsgi.Middleware):
    ...
    def __init__(self, app):
        ...
        self.vnd_mime_type = 'application/vnd.openstack.subjects-'
    ...
    def _get_allowed_versions(self):
        ...
        if CONF.enable_v2_api:
            ...
            allowed_versions['v1.0'] = 2
            allowed_versions['v1.1'] = 2
            allowed_versions['v1.2'] = 2
            allowed_versions['v1.3'] = 2
            allowed_versions['v1.4'] = 2
