...
import subject.db
from subject.glare import dependency
from subject.glare import domain
from subject.glare import location
from subject.glare import updater
...
class Gateway(object):
    ...
    def get_artifact_repo(self, context):
        artifact_repo = subject.db.ArtifactRepo(context,
                                                self.db_api,
                                                self.plugins)
