...
from subject.domain import proxy as subject_proxy
...
class ArtifactHelper(subject_proxy.Helper):
    """
...
class ArtifactBlob(object):
    def __init__(self, base, artifact_blob_proxy_class=None,
        ...
        self.base = base
        self.helper = subject_proxy.Helper(artifact_blob_proxy_class,
...
class List(collections.MutableSequence):
    def __init__(self, base, item_proxy_class=None,
                 item_proxy_kwargs=None):
        self.base = base
        self.helper = subject_proxy.Helper(item_proxy_class, item_proxy_kwargs)
