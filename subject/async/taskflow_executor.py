...
class TaskExecutor(subject.async.TaskExecutor):
    ...
    def __init__(self, context, task_repo, subject_repo, subject_factory):
        ...
        super(TaskExecutor, self).__init__(context, task_repo, subject_repo,
                                           subject_factory)
    ...
    def _get_flow(self, task):
        try:
            ...
            return driver.DriverManager('subject.flows', task.type,
                                        invoke_on_load=True,
